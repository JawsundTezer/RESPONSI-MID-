...
namespace ResponsiPemrograman2701
   
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Karyawan karyawan = new Karyawan(19112701, "Akmal Jawsud", 5000000);
            Karyawan karyawan2 = new Karyawan(19112711, "Bagus Rizky", 3000000);
